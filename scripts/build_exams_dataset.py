...
exams = [
                ...
                "questions": [
                    {
                        ...
                        "vocabularyIds": ["vocab-typing", "vocab-laptop"]
                    },
                    {
                        "id": "t2-l1-q2",
                        "sectionId": "sec-toeic02-l1",
                ...
                "questions": [
                    {
                        ...
                        "options": ["prior", "before", "ahead", "earlier"],
                    ...
                    },
                    {
                        ...
                        "options": ["dependable", "dependably", "dependability", "depended"],
                    ...
                    },
                    {
                        ...
                        "options": ["after", "between", "during", "while"],
                        "correctAnswer": "after",
                ...
                "questions": [
                    {
                        ...
                        "options": ["Consequently", "Similarly", "Nevertheless", "Otherwise"],
                    ...
                    },
                    {
                        ...
                        "options": ["enhance", "resemble", "postpone", "discard"],
            ...
            },
            {
                ...
                "questions": [
                    ...
                    },
                    {
                        ...
                        "options": ["November 12", "November 3", "November 10", "November 14"],
                    ...
                    },
                    {
                        ...
                        "options": ["Port Klang, Malaysia", "Yokohama, Japan", "South China Sea", "Makassar Strait"],
    ...
    # =========================================================================
    # 2. VSTEP B2-C1 Full Language Use & Reading Test
    # =========================================================================
    {
        "id": "exam-vstep-c1",
        ...
        "totalQuestions": 15,
        "maxScore": 10,
        "tags": ["vstep", "b2-c1", "vietnam-standard", "reading", "academic"],
        "isOfficialMock": True,
                ...
                "questions": [
                    {
                        ...
                        "options": ["he had mounted", "had he mounted", "did he mount", "has he mounted"],
                    ...
                    },
                    {
                        ...
                        "options": ["is reviewed", "be reviewed", "was reviewed", "must review"],
                    ...
                    },
                    {
                        ...
                        "options": ["at odds", "in terms", "by virtue", "on par"],
            ...
            },
            {
                ...
                "questions": [
                    ...
                    },
                    {
                        ...
                        "options": ["overwhelmed", "abandoned", "entertained", "purified"],
                    ...
                    },
                    {
                        ...
                        "options": ["analytical and informative", "satirical and cynical", "nostalgic and poetic", "hostile and aggressive"],
                    ...
                    },
                    {
                        ...
                        "options": ["automatically reverted to", "vigorously protested against", "refused to consider", "accidentally paid for"],
    ...
    # =========================================================================
    # 3. IELTS Academic Practice Test 02
    # =========================================================================
    {
        ...
        "totalQuestions": 15,
        "maxScore": 9,
        "tags": ["ielts", "academic", "reading", "listening", "band-8"],
        "isOfficialMock": True,
                ...
                "questions": [
                    {
                        ...
                        "difficulty": "B2",
                        "tags": ["listening", "academic", "tutorial"]
                    },
                    {
                        "id": "i2-l3-q2",
                        "sectionId": "sec-ielts02-l3",
                        ...
                        "difficulty": "C1",
                        "tags": ["listening", "academic", "methodology"]
                    },
                    {
                        "id": "i2-l3-q3",
                        "sectionId": "sec-ielts02-l3",
                        ...
                        "difficulty": "B2",
                        "tags": ["listening", "academic", "action-item"]
                    },
                    {
                        "id": "i2-l3-q4",
                        "sectionId": "sec-ielts02-l3",
                        ...
                        "difficulty": "B2",
                        "tags": ["listening", "academic", "materials"]
                    },
                    {
                        "id": "i2-l3-q5",
                        "sectionId": "sec-ielts02-l3",
                        ...
                        "difficulty": "B2",
                        "tags": ["listening", "academic", "deadline"]
                    }
                ]
            }
        ]
...
header = "import { Exam } from '../../../../packages/domain/src/index.js';\n\nexport const EXPANDED_EXAMS: Exam[] = "
ts_code = header + json.dumps(exams, indent=2, ensure_ascii=False) + ";\n"

with open("apps/api/src/data/examsExpandedData.ts", "w", encoding="utf-8") as f:
    f.write(ts_code)

print(f"Successfully generated {len(exams)} expanded exams in apps/api/src/data/examsExpandedData.ts.")
